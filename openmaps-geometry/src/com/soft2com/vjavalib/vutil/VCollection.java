...
public interface VCollection
{
     ...
     * VCollection classes should clearly specify in their documentation any
     ...
     * @see    #contains(Object)
     */
    boolean containsAll(VCollection c);
     ...
     * @see #contains(Object)
     */
    boolean removeAll(VCollection c);
     ...
     * 	       is not supported by this VCollection.
     * @throws ClassCastException if the types of one or more elements
     *         in this collection are incompatible with the specified
     *         collection (optional).
     * @throws NullPointerException if this collection contains one or more
     ...
     * @see #contains(Object)
     */
    boolean retainAll(VCollection c);
     ...
     *
     * While the <tt>VCollection</tt> interface adds no stipulations to the
     * general contract for the <tt>Object.equals</tt>, programmers who
     * implement the <tt>VCollection</tt> interface "directly" (in other words,
     * create a class that is a <tt>VCollection</tt> but is not a <tt>Set</tt>
     ...
     * <tt>VCollection</tt> interface adds no stipulations to the general
