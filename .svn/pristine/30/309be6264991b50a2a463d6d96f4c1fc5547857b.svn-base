...
public abstract class VAbstractList extends VAbstractCollection implements VList
{
    ...
    public int lastIndexOf(Object o) {
        VListIterator e = listIterator(size());
        if (o==null) {
            while (e.hasPrevious())
                if (e.previous()==null)
                    return e.nextIndex();
     ...
     * @see #modCount
     */
    public VListIterator listIterator(final int index) {
    ...
    private class Itr implements VIterator {
        ...
        public void remove() {
            ...
            try {
                VAbstractList.this.remove(lastRet);
                if (lastRet < cursor)
                    cursor--;
                lastRet = -1;
    ...
    private class ListItr extends Itr implements VListIterator {
        ...
        public void set(Object o) {
            ...
            try {
                VAbstractList.this.set(lastRet, o);
                expectedModCount = modCount;
            } catch(IndexOutOfBoundsException e) {
                throw new VConcurrentModificationException();
            }
        ...
        public void add(Object o) {
            ...
            try {
                VAbstractList.this.add(cursor++, o);
                lastRet = -1;
                expectedModCount = modCount;
            } catch(IndexOutOfBoundsException e) {
                throw new VConcurrentModificationException();
    ...
    public VList subList(int fromIndex, int toIndex) {
        return (this instanceof VRandomAccess ?
    ...
    public boolean equals(Object o) {
        ...
        VListIterator e1 = listIterator();
        VListIterator e2 = ((VList) o).listIterator();
    ...
    protected void removeRange(int fromIndex, int toIndex) {
        VListIterator it = listIterator(fromIndex);
...
class SubList extends VAbstractList {
    ...
    SubList(VAbstractList list, int fromIndex, int toIndex) {
        if (fromIndex < 0)
    ...
    public VListIterator listIterator(final int index) {
        ...
        return new VListIterator() {
            private VListIterator i = l.listIterator(index+offset);
...
class RandomAccessSubList extends SubList implements VRandomAccess {
    RandomAccessSubList(VAbstractList list, int fromIndex, int toIndex) {
